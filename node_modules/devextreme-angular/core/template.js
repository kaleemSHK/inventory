...
var DxTemplateDirective = (function () {
    function DxTemplateDirective(templateRef, viewContainerRef, templateHost, renderer, ngZone) {
    ...
    DxTemplateDirective.prototype.render = function (renderData) {
        ...
        var renderTemplate = function () {
            return _this.viewContainerRef.createEmbeddedView(_this.templateRef, {
        ...
        if (this.ngZone.isStable) {
            childView = this.ngZone.run(function () { return renderTemplate(); });
        }
        else {
