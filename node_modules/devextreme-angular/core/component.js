...
var DxComponent = (function () {
    function DxComponent(element, ngZone, templateHost, watcherHelper, transferState, platformId) {
        ...
        this.eventHelper = new events_strategy_1.EmitterHelper(this);
    }
    ...
    DxComponent.prototype._createEventEmitters = function (events) {
        ...
        this._initialOptions.eventsStrategy = function (instance) {
            var strategy = new events_strategy_1.NgEventsStrategy(ngZone, instance);
        ...
        this._initialOptions.nestedComponentOptions = function (component) {
            return {
                eventsStrategy: function (instance) { return new events_strategy_1.NgEventsStrategy(ngZone, instance); },
