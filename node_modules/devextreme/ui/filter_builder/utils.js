...
function isValidCondition(condition, field) {
    ...
    if (field.dataType && "string" !== field.dataType || isCustomOperation) {
        return "" !== condition[2]
    }
    return true
}
...
function setFocusToBody() {
    ...
    if (doc && doc.activeElement && doc.activeElement.nodeName && "body" !== doc.activeElement.nodeName.toLowerCase()) {
