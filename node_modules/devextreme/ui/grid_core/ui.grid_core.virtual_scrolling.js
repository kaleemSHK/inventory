...
var VirtualScrollingDataSourceAdapterExtender = function() {
    ...
    ["virtualItemsCount", "getContentOffset", "getVirtualContentSize", "setContentSize", "setViewportPosition", "getViewportItemIndex", "setViewportItemIndex", "viewportSize", "viewportItemSize", "getItemSize", "pageIndex", "beginPageIndex", "endPageIndex", "loadIfNeed"].forEach(function(name) {
        ...
        _updateContent: function(tableElement, change) {
            ...
            if ("append" === changeType || "prepend" === changeType) {
                ...
                if (!that.option("legacyRendering") && 1 === $tBodies.length) {
                    contentTable.children("tbody")["append" === changeType ? "append" : "prepend"]($tBodies.children())
                } else {
