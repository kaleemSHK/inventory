...
var ResizingController = modules.ViewController.inherit({
    ...
    _synchronizeColumns: function() {
        var resetBestFitMode, focusedElement, that = this,
    ...
    _correctColumnWidths: function(resultWidths, visibleColumns) {
        ...
        if (!hasAutoWidth && resultWidths.length) {
            ...
            if (totalWidth <= contentWidth) {
                ...
                while (lastColumnIndex >= 0 && visibleColumns[lastColumnIndex] && (visibleColumns[lastColumnIndex].command || resultWidths[lastColumnIndex] === HIDDEN_COLUMNS_WIDTH || visibleColumns[lastColumnIndex].fixed || false === visibleColumns[lastColumnIndex].allowResizing)) {
                    lastColumnIndex--
                }
